...
when RENDER == "RAYLIB" {
	...
	get_text_size :: proc(font: Font, c_str: cstring, font_size: f32) -> mm.V2 {
		return rl.MeasureTextEx(font, c_str, font_size, 1.0) // NOTE: Default spacing = 1.0 (Taken from here: https://github.com/raysan5/raylib/blob/44659b7ba8bd6d517d75fac8675ecd026f713240/src/rtext.c#L1207)
	}
